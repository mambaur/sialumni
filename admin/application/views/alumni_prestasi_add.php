        ...
        <table  width="70%" cellspacing="2" cellpadding="5">
             <form action="" method="post">
                ...
                <tr>
                    <td>Prestasi</td>
                    <td>:</td>
                    <td><input type="text" name="prestasi" class="form-control form-control-user" placeholder="Masukkan Prestasi" /></td>
                </tr>
                <tr>
                    <td>Tahun</td>
                    <td>:</td>
                ...
                <tr>
                    <td>Tingkat</td>
                    <td>:</td>
                    <td><input type="text" name="tingkat" class="form-control form-control-user" placeholder="Masukkan Tingkat"/></td>
                </tr>
				 <tr>
                    <td>Juara</td>
                    <td>:</td>
                    <td><input type="text" name="juara" class="form-control form-control-user" placeholder="Masukkan Juara"/></td>
                </tr>
