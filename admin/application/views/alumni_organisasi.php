      ...
      <div class="table-responsive">
		<div class="modal-body">
				...
				<div class="form-group col-md-3">
					<a href="<?php echo base_url('Alumni/add_organisasi/'.$this->uri->segment(3)); ?>"><button type="button" class="btn btn-primary btn-block btn-user" name="tambah">Tambah</button></a>
				</div>
				<?php } ?>
    	<table class="table table-bordered" id="dataTable"cellspacing="0">			
			...
			<tbody>
				...
				<tr>
					...
					<?php if($_SESSION['user'] == "1") { ?>
					<td align="center"><a href="<?php echo base_url()?>Alumni/edit_organisasi/<?php echo $row->nis; ?>"><i class="fas fa-pencil-alt"></i></a></td>
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <form class="form-horizontal" method="post" action="<?php echo base_url();?>Alumni/hapus_organisasi/<?php echo $row->nis; ?>/<?php echo $row->id_organisasi; ?>">
                  <div class="modal-body">
