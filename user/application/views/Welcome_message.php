        ...
        <div class="row align-items-center menux">
            <div class="col-lg-12">
                <div class="search_form" style="border-radius: 20px;">
                    <div class="form-row">
                        <div class="col-lg-2">
                            <img class="img-fluid" src="<?= base_url('/assets/img/logomalang.png') ?>">
                        </div>
                        <div class="col-lg-10">
     ...
     <div class="row">
        <div class="col-lg-4 col-sm-6">
            <div class="single_donation_item">
                <img style="width: 500px;" class="img-fluid" src="<?= base_url('../admin/images/data.png'); ?>" alt="#">
                <h4>Data Alumni</h4>
            ...
            <div class="row justify-content-between">
                <div class="col-md-6 col-lg-6">
                    <div class="place_detauls_text">
                        ...
                        <img src="<?php echo base_url('assets/img/plase_details_1.png');?>" alt="#">
                    </div>
                </div>
                <div class="col-md-6">
