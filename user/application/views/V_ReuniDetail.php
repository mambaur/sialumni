    ...
    <section class="popular_place padding_top" style="padding-top: 5%;">
        <div class="container-fluid">
            ...
            <?php foreach($data as $a){ ?>
                <div class="col-lg-9" style="margin-bottom: 20px;font-style: justify;"><img class="img-fluid" style="width: 1050px;" src="<?php echo base_url('../admin/images/' . $a->gambar_event);?>" alt="">
