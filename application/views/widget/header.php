...
<head>
    ...
    <title><?= $title; ?></title>
    <link rel="icon" href="<?= base_url('user/assets/img/favicon.png');?>">
            ...
            <div class="row align-items-center">
                <div class="col-lg-12">
                    <nav class="navbar navbar-expand-lg navbar-light">
                        <a class="navbar-brand" href="<?= base_url('Welcome'); ?>"> <img src="<?php echo base_url('user/assets/img/logo.png');?>" alt="logo"> </a>
