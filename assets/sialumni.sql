...
--
-- Host: 127.0.0.1
-- Generation Time: 20 Mar 2020 pada 03.56
...
('awd', 'awdw', 'wadawd', '2020-03-19', 'Laki-laki', '', 'wadaw', 0, 0, '', 'asdasd', 'asdsadasd', '12412', 'awd', 'asdasd', 'asdasd', 'asdasd', '', 'wadad', '111.PNG'),
...
(5, 'awd', 'dhhd', 'k', 123, 'Lain-Lain', 'Tambora 15, Malang'),
(6, 'awd', 'Maling Pro', 'Ketua', 2016, 'Wirausaha', 'Tambora 15, Malang'),
(7, 'awd', 'sadads', 'dadaad', 212, 'PNS', 'daasd');
...
--
ALTER TABLE `tb_pekerjaan`
  MODIFY `id_pekerjaan` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
--
